...
<script type="text/javascript">
	...
	/* oninput을 썼으니까 한글자 한글자마다 실시간 검사해줄것 */
	function nicknameCheck(value) {
		/* document.getElementById("nickname_check_res").innerText = value; */
		...
		$.ajax({
			...
			success: function(data) {
				if(data.result == false) {
					document.getElementById("email_nickname_res").innerText = "사용 가능!";
				} else {
					document.getElementById("email_nickname_res").innerText = "이미 사용중인 닉네임";
				}
			},
		});
	}
